        ...
        if (status == 0) { 
          ...
          *******************************************************************************/
                ...
                if (income <= 13250){
                 ...
                 tax = 13250 * 0.10 + (50400 - 13250) * 0.15 +
                       (130150 - 50400) * 0.25 + (210,800 - 130150) * 0.28 +
                       (income - 210,800) * 0.33;
                 taxRate = 33;
               }//end of else if
               else if (income <= 441,000) {
                  tax = 13250 * 0.10 + (50400 - 13250) * 0.15 +
                        (130150 - 50400) * 0.25 + (210,800 - 130150) * 0.28 +
                        (413350 - 210,800) * 0.33 + (income - 413350) * 0.35;
                  taxRate = 35;
               }//end of else if
               else {
                  tax = 13250 * 0.10 + (50400 - 13250) * 0.15 +
                        (130150 - 50400) * 0.25 + (210,800 - 130150) * 0.28 +
                        (413350 - 210,800) * 0.33 + (441,000 - 413350 ) * 0.35 + (income - 441,000) * .396;
                  taxRate = 39.6;
               }//end of nested if
